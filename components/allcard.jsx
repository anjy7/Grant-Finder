...
export default function AllCards({ project, details, type, category, deadline,imgUrl }) {
    return (
        <div className="h-72 w-80 bg-black rounded-2xl">
            ...
            <div>
                <div className="text-white relative p-2">
                    ...
                    <div  className="text-sm bg-indigo-800 mt-2 w-fit p-1 rounded-sm ">{category}</div>
